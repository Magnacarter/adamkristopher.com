...
<?php if ( $portfolio->have_posts() ) : ?>
	...
	<?php while ( $portfolio->have_posts() ) : $portfolio->the_post(); $i++;
		...
		<div class="feature-project grid-100 grid-parent">
			<a href=""><img src="<?php the_field( 'project_image' ) ?>"></a>
				<div class="feature-hover grid-40 tablet-grid-50">
		...
		<div class="single-project-wrap grid-33 tablet-grid-50 mobile-grid-100">
			<div class="single-project">
				<a href="<?php echo esc_url( get_permalink() ) ?>"><img src="<?php the_field( 'project_image' ) ?>" alt="<?php the_field( 'project_description' ) ?>"/></a>
					<div class="single-hover">
						<span><h3><i><?php echo esc_html( get_the_title() ) ?></i></h3></span>
